...
namespace SSYM.OrgDsn.UI
{
    ...
    public class DelayedBindingTextBox : TextBox
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            var button = this.Template.FindName("btnClear", this) as Button;
            if (button != null)
                button.Click += DelayedBindingTextBox_Click;
        }

        void DelayedBindingTextBox_Click(object sender, RoutedEventArgs e)
        {
